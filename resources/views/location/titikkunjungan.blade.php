...
<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Input Titik Kunjungan <br>
                            <small>Masukkan Data Titik Kunjungan</small>
                        </h1>
            <ol class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><a href="#">GeoLocation</a></li>
  <li class="active">Input Titik Kunjungan</li>
</ol>
                    </div>
                </div>
            </div>
...
<div class="col-md-6">
    ...
    <div class="block margin-bottom-sm"> 
      <div class="card-header"><center><h2 class="h3 no-margin-bottom">Scan Lokasi</h2></center></div>
      <br>
...
<div class="col-md-6">
  ...
  <div class="card">
    <div class="block margin-bottom-sm">
      <div class="card-header"><center><h2 class="h3 no-margin-bottom">Titik Kunjungan</h2></center></div>
      <br><br><br><br><br><br>
